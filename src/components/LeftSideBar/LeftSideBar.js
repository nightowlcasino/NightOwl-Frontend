...
const LeftSideBar = () => {
	...
	return (
		<div className="hidden lg:flex flex-col lg:ml-12 xl:ml-0 mt-[1.25rem] h-full gap-4">			
				<div style={{backgroundImage:"linear-gradient(to bottom left, #d70a84, #51127f)"}} className=" flex flex-col justify-center items-center h-[700px] max-w-[25vw] lg:w-[25vw] xl:w-[18vw] 2xl:max-w-[300px] rounded-3xl">
