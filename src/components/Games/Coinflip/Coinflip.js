...
const Coinflip = () => {
	...
	const [selection_state] = useState(false);
			...
			<div id="coinflip-content">
				<div id="coinflip-header-wrapper">
					<div id="coinflip-header">
						<label onClick={() => selection_state(true)} className="side-selector" htmlFor="head-side-selector">
							<input name="coin-side-selector" id="head-side-selector" type="radio" value="head" checked={selection_state}  />
							<h1 className="side-selector-name">Head</h1>
						</label>
						<h1 id="spacer">/</h1>
						<label onClick={() => selection_state(false)} className="side-selector" htmlFor="tail-side-selector">
							<input name="coin-side-selector" id="tail-side-selector" type="radio" value="tail" checked={selection_state} />
