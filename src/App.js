...
function App() {
	...
	return (
		<div className="App">
			<div className=" xl:min-w-[1200px] max-w-[1600px] h-[100%] flex flex-col justify-center mt-[15px] lg:gap-2">
				...
				<div className="h-[100%] flex justify-between min-w-[100%] mt-[10rem]">
